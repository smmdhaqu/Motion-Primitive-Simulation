...
for fl in files:
    ...
    txt = ax.text((lim_ref[fl][0] + lim_ref[fl][1]) / 2, (lim_ref[fl][2] + lim_ref[fl][3]) / 2, lim_ref[fl][5] + ((lim_ref[fl][4] - lim_ref[fl][5]) * 90 / 100), '', fontsize=15)
